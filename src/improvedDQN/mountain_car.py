...
def main():
    ...
    test_evn = gym.wrappers.Monitor(
        env, './videos/improvedDQN_mountain_car-v0', force=True)
    ...
    agent.visualize_loss('improvedDQN_mountain_car_loss')
    visualize(training_test_rewards, 'improvedDQN_mountain_car_training_test_rewards.png')
    visualize(test_rewards, 'improvedDQN_mountain_car_test_rewards.png')
