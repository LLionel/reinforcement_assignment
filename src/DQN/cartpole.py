...
def main():
    ...
    test_evn = gym.wrappers.Monitor(
        env, './videos/DQN_cartpole-v0', force=True)
    ...
    agent.visualize_loss('DQN_cartpole_loss.png')
    visualize(training_test_rewards, 'DQN_carpole_training_test_rewards.png')
    visualize(test_rewards, 'DQN_carpole_test_rewards.png')
