...
def main():
    ...
    test_evn = gym.wrappers.Monitor(
        env, './videos/DQN_acrobot-v0', force=True)
    for episode in range(TEST_EPISODE):
        ...
        while True:
            ...
            if done:
                ...
                break
    test_evn.close()
    agent.visualize_loss('DQN_acrobot_loss.png')
    visualize(training_test_rewards, 'DQN_acrobot_training_test_rewards.png')
    visualize(test_rewards, 'DQN_acrobot_test_rewards.png')
