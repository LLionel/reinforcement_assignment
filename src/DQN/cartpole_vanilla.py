...
def main():
    ...
    test_evn = gym.wrappers.Monitor(
        env, './videos/DQN_vanilla_cartpole-v0', force=True)
    for episode in range(TEST_EPISODE):
        ...
        while True:
            ...
            if done:
                ...
                break
    # test_evn.close()
    agent.visualize_loss('DQN_vanilla_cartpole_loss.png')
    visualize(training_test_rewards, 'DQN_vanilla_carpole_training_test_rewards.png')
    visualize(test_rewards, 'DQN_vanilla_carpole_test_rewards.png')
